import { List, ListItem, ListItemButton, ListItemAvatar, ListItemText, Box, useTheme, ListItemIcon, Typography } from "@mui/material";
...
const ExplorerCategories = () => {
    ...
    const { dataCRUD, error, isLoading, fetchData } = useCrud<Category>([], "/servers/categories");
                            ...
                            >
                                <ListItemIcon sx={{ minWidth: 0, justifyContent: "center"}}>
                                    <ListItemAvatar sx={{minWidth: "0px"}}>
                                        <img 
                                            alt="category icon" 
                                            src={`${BACKEND_MEDIA_URL}${item.icon}`}
